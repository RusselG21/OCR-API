...
class BirthCertExtractor(BaseExtractor):
    ...
    def _extract_birth_cert_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "birth_info": self._extract_birth_info(fields)
        }
    ...
    def _extract_personal_info(self, fields: Dict[str, Any]) -> Dict[str, str]:
        ...
        return {
            ...
            "Name_Confidence": name_field.get("confidence", 0)
        }

    def _extract_birth_info(self, fields: Dict[str, Any]) -> Dict[str, str]:
        """Extract birth information from birth certificate"""
        dob_field = fields.get("Date_Of_Birth", {})
        return {
            "Date_Of_Birth": dob_field.get("value", ""),
            "Date_Of_Birth_Confidence": dob_field.get("confidence", 0)
        }
